...
public class SendMail {
	// 发件人邮箱地址
	private static String from = "xiehao2@sunline.cn";
	// 发件人称号，同邮箱地址
	private static String user = "xiehao2@sunline.cn";
	// 发件人邮箱客户端授权码
	private static String password = "QZpm!#24";
	//发件人的邮箱服务器
	private static String mailHost = "smtp.sunline.cn";
	...
	public static void main(String[] args) { // 做测试用
		...
		String toMail = "746625878@qq.com";
