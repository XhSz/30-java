...
public class JavaSmsApi {
  ...
  public static void main(String[] args) {
	    String apikey = "7d466a3ed7b5f71bc9f1b62f1c05bd32";
			String ENCODING = "UTF-8";
			try {
			    String tpl_value = URLEncoder.encode("#user_id#",ENCODING) +"="
			    	    + URLEncoder.encode("test0072", ENCODING) + "&"
			    	    + URLEncoder.encode("#user_password#",ENCODING) + "="
			    	    + URLEncoder.encode("123456",ENCODING)+ "&"
			    	    + URLEncoder.encode("#user_id2#",ENCODING) + "="
			    	    + URLEncoder.encode("super",ENCODING);
			    System.out.println("模板结果="+JavaSmsApi.tplSendSms(apikey, 4008950L, tpl_value, "+60"+"192390727"));
			} catch (Exception e) {
				e.printStackTrace();
			}
  }
  ...
  public static void main2(String[] args) throws IOException, URISyntaxException {
    ...
    //修改为您要发送的手机号
    String mobile = "15013632409";
    mobile = "15013632409";			//xiehao
    mobile = "+60192390727";		//cp
    
    /**************** 查账户信息调用示例 *****************/
    System.out.println("查账户信息调用示例="+JavaSmsApi.getUserInfo(apikey));
 
    /**************** 使用智能匹配模板接口发短信(推荐) *****************/
    //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
    String text = "【云片网】您的验证码是1234";
    text = "You have a to-do item to be approved .[ From Jocom Counter]";
    text = "xiehao test";
    
    //发短信调用示例
    System.out.println("智能模板="+JavaSmsApi.sendSms(apikey, text, mobile));
...
//    System.out.println("模板示例="+tpl_value);
    tpl_value = "";
    //模板发送的调用示例
    System.out.println("模板结果="+JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value, mobile));
