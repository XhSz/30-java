...
public class Trans {
    ...
    public static void main(String[] argso) {
        ...
        String paraE2C = "client=t&sl=en&tl=zh-CN&hl=zh-CN&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&otf=1&ssel=0&tsel=0&kc=1&tk="+ Trans.getTK(args[0])+"&q="+args[0];
        String paraC2E = "client=t&sl=zh-CN&tl=en&hl=en&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&otf=1&ssel=0&tsel=0&kc=1&tk="+ Trans.getTK(args[0])+"&q="+args[0];
        String paraTest = "client=t&sl=en&tl=zh-CN&hl=zh-CN&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&otf=1&ssel=0&tsel=0&kc=1&tk="+Trans.getTK("book")+"&q="+"book";
...
//            System.out.println(js1.getJSONArray(i).get(0).toString()+":");
//            JSONArray wordsArray = js1.getJSONArray(i).getJSONArray(1);
//            for(int j=0;j<wordsArray.size();j++){
//                System.out.print(wordsArray.get(j)+"; ");
//            }
//            System.out.println("\n");
//
//        }
        ...
        //System.out.println(Trans.getTK());
