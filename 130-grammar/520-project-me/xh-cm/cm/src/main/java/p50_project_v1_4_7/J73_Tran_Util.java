...
public class J73_Tran_Util {
	public static String[] KEY_FOLD = {		"-tran",	"java",		"tables" ,"namedsql" ,	"batchtran",		"type"};
	public static String[] KEY_FILE = {".flowtrans.xml",".java",".tables.xml",".nsql.xml",".batch_tran.xml",".e_schema.xml"};
										//		0			1			2			3			4				5
	/**
	 * 扫描代码根目录，获得特定文件工程路径
	 * @param path
                    ...
                    if (childFile.isDirectory()) {
                    	...
                    	if(childFile.getAbsolutePath().endsWith(KEY_FILE[key])) {
                            ...
                            if(2==key) {
                            	...
                            	J3_Util.parseEnum(childFile.getAbsolutePath(),keySet,objSet);
                            }
                    	}
                    }
                }
