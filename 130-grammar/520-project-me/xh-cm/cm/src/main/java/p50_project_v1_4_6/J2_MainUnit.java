...
//    		"06"	//06 local
	...
	public static boolean IS_PRINT_EXCEL = false;
	...
	public static String STR_7_ENUM_PRINT = "7_ENUM_PRINT-输出excel";
	...
	public static Thread THREAD_7_ENUM_PRINT = new Thread(){
        public void run(){
    		J3_Util.logB(STR_7_ENUM_PRINT);
        	boolean start = false;
    		while(!start) {
        		try {
					Thread.sleep(3000);
					System.out.println(STR_7_ENUM_PRINT+":"+DO_5_DB_2_TABLES_1_INIT);
					start = DO_5_DB_2_TABLES_1_INIT;
				} catch (InterruptedException e) {
					e.printStackTrace();
				}
        	}
	...
	public static Set<String> enumKeySet = new HashSet<String>();
	public static Set<J1_BeanEnum> enumSet = new HashSet<J1_BeanEnum>();
	public static Map<String,String> enumMap = new HashMap<String,String>();
	public static String STR_7_ENUM_1_INIT = "7_ENUM_1_INIT-枚举初始化-遍历文件";
	public static boolean DO_7_ENUM_1_INIT = false;//枚举初始化-遍历文件
	public static String STR_7_ENUM_2_INSERT = "7_ENUM_2_INSERT-枚举初始化-入库";
	public static boolean DO_7_ENUM_2_INSERT = false;//枚举入库  
	public static boolean DO_7_ENUM_4_INIT = false;//枚举初始化-查询数据库 
	public static String STR_7_ENUM_4_INIT = "6_BAT_4_INIT-枚举初始化-查询数据库";
...
//    		J2_MainUnit.CP="D:\\03-sl-107-code\\26-gs\\99-3.0.4-stable\\dp-base\\dp-base";
	...
	public static Thread THREAD_7_ENUM_1_INIT = new Thread(){
        public void run(){
    		J3_Util.logB(STR_7_ENUM_1_INIT);
			J73_Tran_Util.scanFolder(CP,5,enumKeySet,enumSet);//5,enum
    		J3_Util.logE(STR_7_ENUM_1_INIT);
    		DO_7_ENUM_1_INIT = true;
        }
    };
	public static Thread THREAD_7_ENUM_2_INSERT = new Thread(){
        public void run(){
        	while(!DO_7_ENUM_1_INIT) {
        		try {
					Thread.sleep(1000);
				} catch (InterruptedException e) {
					e.printStackTrace();
    		...
    		J3_Util.logB(STR_7_ENUM_2_INSERT);
	    	if(!isRealTime) {
				J5_Sql.doMain(447, null);//447,del all,tree_enum
		    	J5_Sql.doMain(137,enumSet);//137,batch insert,tree_enum
        	}
    		J3_Util.logE(STR_7_ENUM_2_INSERT);
    		DO_7_ENUM_2_INSERT = true;
        }
    };
    public static Thread THREAD_7_ENUM_4_INIT = new Thread(){
        public void run(){
    		J3_Util.logB(STR_7_ENUM_4_INIT);
        	while(!(DO_7_ENUM_1_INIT||isReadyPrint||DO_7_ENUM_2_INSERT)) {
        		try {
					Thread.sleep(1000);
				} catch (InterruptedException e) {
					e.printStackTrace();
    		...
    		if(DO_7_ENUM_1_INIT) {
    			for(J1_BeanEnum bean:enumSet) {
    				enumMap.put(bean.getEnum_name(), bean.getEnum_des());
    			}
    		}else if(isReadyPrint||DO_7_ENUM_2_INSERT) {
    			J5_Sql.doMain(347, enumMap);//347,select all,tree_batch
    		}
    		J3_Util.logE(STR_7_ENUM_4_INIT);
    		DO_7_ENUM_4_INIT = true;
        }
    };
