...
public class J1_BeanTranRelate {
	public String tran_name;
	public int seq_no;
	public String block_test;
	...
	public String getBlock_test() {
		return block_test;
	}
	public void setBlock_test(String block_test) {
		this.block_test = block_test;
	}
