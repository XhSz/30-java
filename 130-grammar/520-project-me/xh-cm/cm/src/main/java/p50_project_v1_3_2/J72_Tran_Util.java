...
public class J72_Tran_Util {
	 ...
	 * @param tranList
	 */
    public static void scanJavaFolder(String path,Set<String> callList,List<J1_BeanCallRelate> callRelateList) {
...
//                            System.out.println(file2.getAbsolutePath()+":ok!");
                            scanJavaFolder(file2.getAbsolutePath(),callList,callRelateList);
                    	...
                    	if(file2.getAbsolutePath().endsWith(".java")) {
                            ...
                            J3_Util.parseJava(file2.getAbsolutePath(),callList,callRelateList);
                    	}
                    }
                }
            }
...
//    	String path = "D:\\03-sl-107-code\\26-gs\\99-3.0.4-stable\\dp-busi\\dp-serv\\src\\main\\java\\cn\\sunline\\icore\\dp\\serv\\account\\open\\DpOpenAccount.java";
    	String path = 
...
//    			"D:\\03-sl-107-code\\26-gs\\99-3.0.4-stable\\us-busi\\us-serv\\src\\main\\java\\cn\\sunline\\icore\\us\\serv\\base\\UsBatchAccounOpen.java"
        ...
        J3_Util.parseJava(path,new HashSet<String>(),null);
	}
    public static void main(String[] args) {
		...
		J3_Util.parseJava(path,callSet,callRelateList);
	}
